...
extension Product {
        ...
        .SubscriptionPeriod?
    {
        ...
        return periods.max(by: {
            $0.approximateDays(calendar: calendar) < $1.approximateDays(calendar: calendar)
        })
    }
...
extension Product.SubscriptionPeriod {
    ...
    public func interval(from start: Date, calendar: Calendar = .autoupdatingCurrent)
        -> DateInterval?
    {
