...
public final class AppInfoKit: @unchecked Sendable {
    ...
    public var appName: String {
        let b = Bundle.main
        if let s = b.localizedInfoDictionary?["CFBundleDisplayName"] as? String, !s.isEmpty {
            return s
        }
        if let s = b.object(forInfoDictionaryKey: "CFBundleDisplayName") as? String, !s.isEmpty {
            return s
        }
        if let s = b.object(forInfoDictionaryKey: "CFBundleName") as? String, !s.isEmpty {
            return s
        }
